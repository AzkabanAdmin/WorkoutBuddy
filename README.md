...
Press **Save** to add the trigger, then close the window with its built‑in **Close** button. Custom events appear as boxed options with pencil and X icons for editing or deletion.
